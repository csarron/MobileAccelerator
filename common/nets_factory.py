...
networks_map = {'squeezenet': squeezenet.squeezenet,
                ...
                'inception_v3_custom': inception.inception_v3_custom,
...
def get_network_fn(name, num_classes, weight_decay=0.0, is_training=False, cust_arg_1=384):
    ...
    def network_fn(images, **kwargs):
        ...
        with slim.arg_scope(arg_scope):
            return func(images, num_classes, is_training=is_training, cust_arg_1=cust_arg_1, **kwargs)
...
arg_scopes_map['alexnet_fw5'] = alexnet_fw5.alexnet_fw5_arg_scope
networks_map['alexnet_fd2'] = alexnet_fd2.alexnet_fd2
