...
alexnet_fw1_arg_scope = alexnet.alexnet_v2_arg_scope


def alexnet_fw1(inputs,
                num_classes=1000,
                is_training=True,
    ...
    with tf.variable_scope(scope) as sc:
        ...
        with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.max_pool2d],
            ...
            net = slim.conv2d(net, 874, [1, 1], scope='conv3')
            net = slim.conv2d(net, 874, [1, 1], scope='conv4')
...
alexnet_fw1.default_image_size = 224
