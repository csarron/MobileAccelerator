...
alexnet_fd2_arg_scope = alexnet.alexnet_v2_arg_scope


def alexnet_fd2(inputs,
                num_classes=1000,
                is_training=True,
    ...
    with tf.variable_scope(scope) as sc:
        ...
        with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.max_pool2d],
            ...
            for i in range(6):
                net = slim.conv2d(net, 256, [2, 2], scope='conv3_%d' % (i + 3))
...
alexnet_fd2.default_image_size = 224
