...
alexnet_wd13_arg_scope = alexnet.alexnet_v2_arg_scope


def alexnet_wd13(inputs,
                num_classes=1000,
                is_training=True,
    ...
    with tf.variable_scope(scope) as sc:
        ...
        with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.max_pool2d],
            ...
            for i in range(10):
                net = slim.conv2d(net, 110, [3, 3], scope='conv%d' % (i + 3))
            net = slim.conv2d(net, 256, [3, 3], scope='conv13')
...
alexnet_wd13.default_image_size = 224
